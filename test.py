...
with torch.no_grad():
  #net=generator()
  net2=torch.load("/public/zebanghe2/derain/reimplement/residualse/ressenet_try1_3stg_49.pth")
  net1=torch.load("/public/zebanghe2/derain/reimplement/residualse/basnet_try1_3stg_49.pth")
  #print(net)
net1.eval()
net1.cuda()
net2.eval()
...
for path,dir_list,file_list in g:  
    for file_name in file_list:
      ...
      tests=tests.cuda()
      with torch.no_grad():
        dout,d1,d2,d3,d4,d5,d6,db=net1(tests)
        outmap=F.sigmoid(dout+d1+d2+d3+d4+d5+d6+db)
        real_D=net2(tests,outmap)
      ...
      #print(outmap)
      mask1=tensor2im(d1.cpu()[0,:,:,:])
      #print(mask1)
      
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d1.png',h,w)
      mask1=tensor2im(dout.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_dout.png',h,w)
      mask1=tensor2im(d2.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d2.png',h,w)
      mask1=tensor2im(d3.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d3.png',h,w)
      mask1=tensor2im(d4.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d4.png',h,w)
      mask1=tensor2im(d5.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d5.png',h,w)
      mask1=tensor2im(d6.cpu()[0,:,:,:])
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_d6.png',h,w)
      mask1=tensor2im(db.cpu()[0,:,:,:])
      #save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_db.png',h,w)
      ...
      #print(mask1)
      save_img(mask1,"/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_bg.jpg',h,w)
      #mask1=tensor2im(outmap.cpu()[0,:,:,:])
      ...
      sodmask=cv2.resize(sodmask,(h,w))
      cv2.imwrite("/public/zebanghe2/20200706/myimplement/residualse/"+file_name.split('.')[0]+'_map.png',sodmask)
